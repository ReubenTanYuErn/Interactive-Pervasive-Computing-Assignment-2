	...
	$query = "SELECT * FROM motion_logs ORDER BY timestamp ASC";

	if($result = mysqli_query($dblink, $query)){
		echo "Reading records successfully from motion_logs <br>";
	} else {
...
<div class="w3-top">
  <div class="w3-bar w3-green w3-card w3-left-align w3-large">
	...
	<header class="w3-container w3-green w3-center" style="padding:20px 16px">
	  <h1 class="w3-margin w3-jumbo">Motion</h1>
